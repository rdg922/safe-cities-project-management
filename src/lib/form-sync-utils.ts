...
export function isFormDataColumn(columnIndex: number, formDataColumnCount: number): boolean {
...
export function generateSyncedSheetSchema(formFields: Array<{ id: number; label: string; type: string }>) {
    const systemColumns = [
        { id: 0, label: 'Submission ID', type: 'text', columnType: 'system' as const, isFormData: true },
        { id: 1, label: 'Submitted At', type: 'text', columnType: 'system' as const, isFormData: true },
        { id: 2, label: 'Submitter Name', type: 'text', columnType: 'system' as const, isFormData: true },
        { id: 3, label: 'Submitter Email', type: 'text', columnType: 'system' as const, isFormData: true },
    ]
