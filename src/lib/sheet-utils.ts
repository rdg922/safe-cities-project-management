import { type Cell, type CellChange, type Row, type DefaultCellTypes } from "@silevis/reactgrid";
...
export function applyChangesToSheet(
  ...
  changes.forEach((change) => {
    ...
    if (formDataColumnCount && isFormDataColumn(change.columnId as number, formDataColumnCount)) {
      return;
    }
